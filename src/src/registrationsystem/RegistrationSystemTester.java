...
public class RegistrationSystemTester {
    ...
    public static void main(String[] args) {
        ...
        //Validating test, if expected output meets actual output
        if (st1.getStudentBirthday().equals(LocalDate.of(1974, Month.APRIL, 12))
             &&
            st1.getStudentAge() == Period.between(LocalDate.of(1974, Month.APRIL, 12), LocalDate.now()).getYears()) {
            marks++;
        ...
        //Validating test, if expected output meets actual output
        if (st2.getStudentAge() == Period.between(LocalDate.of(1999, Month.DECEMBER, 31), LocalDate.now()).getYears()) {
            marks++;
        } else {
    ...
    /************************************************* Test 5 ***********************************************/
        ...
        System.out.printf("%nExpected output:Karen Vader is "+
        Period.between(LocalDate.of(1974, Month.APRIL, 12), LocalDate.now()).getYears()+" " +
                "years old.");//run program to see expected output
